...
# 2.  PostgreSQL was installed, and a user with my username was created
# 3.  The password for the PostgreSQL user '5329' was stored in the .pgpass file,
#     in the format:
...
con <- dbConnect(drv, dbname="fires", host="localhost", port="5432", user="user")
