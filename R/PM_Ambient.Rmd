...
print(paste0("The t-test resulted in p value = ", round(t_test$p.value, digits = 5), ", mean of DT_ILK = ", round(t_test$estimate[1], digits = 2), " and mean of BAM_CSTEP = ", round(t_test$estimate[2], digits=2)))
```
